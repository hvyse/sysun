...
UUID=${UUID:-'0564900c-dac3-4a94-a5c8-f838569716ba'}
VMESS_WSPATH=${VMESS_WSPATH:-'/Pqpa209h3TJD5sj'}
VLESS_WSPATH=${VLESS_WSPATH:-'/XK6sICAGMnJLzE'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/qwzmyyjr'}
SS_WSPATH=${SS_WSPATH:-'/dobd9r2DMPTmZ'}
